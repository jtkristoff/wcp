...
% how long to notice invalid?  depends on ROV validator cache timers?
% might be a useful measure
...
% security concerns?  ARIN?  Sub-allocations/dependecies
% \subsection{ROA maxLength}
\subsubsection{Method}
\subsubsection{Evaluation}
...
% provider-specific looking glasses should support rpki
% use of bmp for route collectors?
Baz.
